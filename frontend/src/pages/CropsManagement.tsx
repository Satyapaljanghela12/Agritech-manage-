...
import { Crop, LandParcel } from '../types';
...
export const CropsManagement = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const payload = {
        ...
        areaPlanted: Number(formData.area_planted),
        plantedOn: formData.planted_on,
        expectedHarvestDate: formData.expected_harvest_date,
        status: formData.status,
        yieldExpected: Number(formData.yield_expected) || 0,
        landParcelId: formData.land_parcel_id || null,
  ...
  const handleEdit = (crop: Crop) => {
    ...
    setFormData({
      ...
      area_planted: String(crop.areaPlanted),
      planted_on: crop.plantedOn,
      expected_harvest_date: crop.expectedHarvestDate,
      status: crop.status,
      yield_expected: String(crop.yieldExpected),
      land_parcel_id: crop.landParcelId || '',
      notes: crop.notes || '',
    });
    setShowForm(true);
  };
  ...
  const totalAreaCultivated = crops.reduce((sum, crop) => sum + Number(crop.areaPlanted), 0);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {crops.map((crop) => (
          <div key={crop._id} className="bg-white rounded-xl p-6 border border-gray-200">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between text-sm">
                ...
                <span className="font-semibold text-gray-800">{crop.areaPlanted} acres</span>
              </div>
              ...
              {crop.yieldExpected > 0 && (
                <div className="flex items-center justify-between text-sm">
                  <span className="text-gray-600">Expected Yield</span>
                  <span className="font-semibold text-gray-800">
                    {crop.yieldExpected} tons
                  </span>
                </div>
              )}
