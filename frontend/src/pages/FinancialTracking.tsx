...
import { FinancialRecord, Crop } from '../types';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const payload = {
        ...
        date: formData.date,
        cropId: formData.crop_id || null,
      };

      if (editingRecord) {
        await api.updateFinancialRecord(editingRecord._id, payload);
      } else {
        await api.createFinancialRecord(payload);
      }
