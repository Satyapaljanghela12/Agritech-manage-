        ...
        <div className="flex flex-col h-full">
          <div className="flex items-center gap-3 px-6 py-5 border-b border-gray-200 dark:border-gray-700">
            <img 
              ...
              style={{ filter: 'saturate(1.5) brightness(1.1) drop-shadow(0 0 10px rgba(0, 166, 81, 0.2))' }}
            />
            <div>
              <p className="text-xs text-gray-400 dark:text-gray-400 font-bold uppercase tracking-wider">{profile?.farm_name || 'Your Farm'}</p>
            </div>
          </div>
